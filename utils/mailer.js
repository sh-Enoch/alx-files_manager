...
/**
 * Function that gets and store new token after prompting for user authorization
 * then execute the given callback with the authorized OAuth2 client.
...
/**
 * Function that create an OAuth2 client with the given credentials
