...
/**
 * Function that generates the thumbnail of an image with a given width size.
...
userQueue.process(async (job, done) => {
  ...
  try {
    ...
    const mailContent = [
      ...
      'Welcome to <a href="https://github.com/Ivy-Chelsea/alx-files_manager">',
      'ALX-Files_Manager</a>, ',
      'a simple file management API built with Node.js by ',
      '<a href="https://github.com/Ivy-Chelsea">Ivy Chelsea</a>. ',
